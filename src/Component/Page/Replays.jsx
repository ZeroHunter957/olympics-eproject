  ...
  return (
    <div className='replays'>
        <div className="card mb-3">
            <img src="/images/replays.png" className="card-img-top" alt="..." />
            <div className="card-body position-absolute text-light container">
                <div className="row row-cols-2 justify-content-between m-5">
                    <h5 className="card-title col w-25 lh-1 ms-5 ps-5">OLYMPIC <br /> REPLAYS</h5>
                    <p className="card-text col w-50 ms-5 ps-5 pt-3 ">From Usain Bolt's gold-medal sprints to Nadia Comaneci's perfect scores, watch how Olympic legends were created and discover historic moments from past Games in our replays & highlights library</p>
                </div>
            </div>
        </div>
