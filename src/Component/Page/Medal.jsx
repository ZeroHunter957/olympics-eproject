  ...
  return (
    <div className='results'>
        <div className="card mb-3">
            <img src="/images/medal.png" className="card-img-top" alt="..." />
            <div className="card-body position-absolute text-light container">
                <div className="row row-cols-2 justify-content-between m-5">
                    <h5 className="card-title col w-25 lh-1 ms-5 ps-5">OLYMPIC <br /> MEDALS</h5>
                    <p className="card-text col w-50 ms-5 ps-5 pt-3 ">Gold, silver and bronze medals are awarded to the top finishers in every event at the Olympic Games - a tradition that began at the St. Louis 1904 Olympic Games.</p>
                </div>
            </div>
        </div>
        <div className="About container my-5">
          <div className="row row-cols-2 justify-content-between">
            <div className="title col-4 h2 fs-1">About the medals</div>
             <div className="text col-8 fs-4">The gold, silver and bronze medals awarded to competitors at the Olympics and Paralympics represent the highest levels of athletic achievement at the Games. The design of the medals is the responsibility of the host city's organizing committee, and varies with each edition of the Games.</div>
          </div>
        </div>
