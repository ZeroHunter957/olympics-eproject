  ...
  return (
    <div className='torches'>
        <div className="card mb-3">
            <img src="/images/torches.png" className="card-img-top" alt="..." />
            <div className="card-body position-absolute text-light container">
                <div className="row row-cols-2 justify-content-between m-5">
                    <h5 className="card-title col-4 w-25 lh-1 ms-5 ps-5">THE OLYMPIC TORCHES</h5>
                    <p className="card-text col-8 w-50 ms-5 ps-5 pt-3 ">A modern invention inspired by practices from ancient Greece, the Olympic Torch Relay heralds the start of the Olympic Games and transmits a message of peace and friendship along its route.</p>
                </div>
            </div>
        </div>
        <div className="About container my-5">
          <div className="row row-cols-2 justify-content-between">
            <div className="title col-4 h2 fs-1">About the torches</div>
             <div className="text col-8 fs-4">First used at the 1936 Berlin Summer Olympics, the modern torches of the Summer and Winter Olympics are built to resist the effects of wind and rain as they carry the Olympic flame, and bear unique designs that represent the host country and the spirit of the Games.</div>
          </div>
        </div>
